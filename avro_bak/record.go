...
type Record struct {
	...
	Fields *UnionNullString `json:"fields"`

	BeforeImages *UnionNullString `json:"beforeImages"`

	AfterImages *UnionNullString `json:"afterImages"`
}

const RecordAvroCRC64Fingerprint = "\xfe\xccР\xcbuE\xd5"
...
func writeRecord(r *Record, w io.Writer) error {
	...
	err = writeUnionNullString(r.Fields, w)
	if err != nil {
		return err
	}
	err = writeUnionNullString(r.BeforeImages, w)
	if err != nil {
		return err
	}
	err = writeUnionNullString(r.AfterImages, w)
	if err != nil {
		return err
	}
	return err
...
func (r *Record) Get(i int) types.Field {
	...
	case 11:
		r.Fields = NewUnionNullString()

		return r.Fields
	case 12:
		r.BeforeImages = NewUnionNullString()

		return r.BeforeImages
	case 13:
		r.AfterImages = NewUnionNullString()
