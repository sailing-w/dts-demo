...
const (
	...
	OperationCOMMAND  Operation = 8
	OperationFILL     Operation = 9
	OperationFINISH   Operation = 10
	OperationCONTROL  Operation = 11
	OperationRDB      Operation = 12
	OperationNOOP     Operation = 13
)
