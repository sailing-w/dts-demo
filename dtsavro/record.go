...
type Record struct {
	...
	BeforeImages *UnionNullArrayUnionNullIntegerCharacterDecimalFloatTimestampDateTimeTextGeometryBinaryObjectTextObject `json:"beforeImages"`

	AfterImages *UnionNullArrayUnionNullIntegerCharacterDecimalFloatTimestampDateTimeTextGeometryBinaryObjectTextObject `json:"afterImages"`
	// the timestamp in unit of millisecond that record is born in source
	BornTimestamp int64 `json:"bornTimestamp"`
}

const RecordAvroCRC64Fingerprint = "y86\xe0\xb3\xfc\xb0\x1e"
...
func writeRecord(r *Record, w io.Writer) error {
	...
	err = writeUnionNullArrayUnionNullIntegerCharacterDecimalFloatTimestampDateTimeTextGeometryBinaryObjectTextObject(r.BeforeImages, w)
	if err != nil {
		return err
	}
	err = writeUnionNullArrayUnionNullIntegerCharacterDecimalFloatTimestampDateTimeTextGeometryBinaryObjectTextObject(r.AfterImages, w)
	if err != nil {
		return err
	}
...
func (r *Record) Get(i int) types.Field {
	...
	case 11:
		...
		return r.Fields
	case 12:
		r.BeforeImages = NewUnionNullArrayUnionNullIntegerCharacterDecimalFloatTimestampDateTimeTextGeometryBinaryObjectTextObject()

		return r.BeforeImages
	case 13:
		r.AfterImages = NewUnionNullArrayUnionNullIntegerCharacterDecimalFloatTimestampDateTimeTextGeometryBinaryObjectTextObject()
