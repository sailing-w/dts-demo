...
const DecimalAvroCRC64Fingerprint = "\x1bEZ^\v\xae\x84*"
...
func (r *Decimal) Schema() string {
	return "{\"fields\":[{\"name\":\"value\",\"type\":\"string\"},{\"name\":\"precision\",\"type\":\"int\"},{\"name\":\"scale\",\"type\":\"int\"}],\"name\":\"Decimal\",\"type\":\"record\"}"
}
