...
const FloatAvroCRC64Fingerprint = "b\xabe\xdb\x1c\x9c\xcd\n"
...
func (r *Float) Schema() string {
	return "{\"fields\":[{\"name\":\"value\",\"type\":\"double\"},{\"name\":\"precision\",\"type\":\"int\"},{\"name\":\"scale\",\"type\":\"int\"}],\"name\":\"Float\",\"type\":\"record\"}"
}
