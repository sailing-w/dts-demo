...
const BinaryObjectAvroCRC64Fingerprint = "\x12s\x01]\xf9\xfd\xbd\xc4"
...
func (r *BinaryObject) Schema() string {
	return "{\"fields\":[{\"name\":\"type\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"bytes\"}],\"name\":\"BinaryObject\",\"type\":\"record\"}"
}
